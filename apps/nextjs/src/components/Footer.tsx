    ...
    return (
        <footer className='w-full flex flex-col items-center justify-center bg-leadistroBlack text-leadistroWhite'>
            <div className="flex w-full p-4 items-center justify-between">
                ...
                <div className='grid font-poppins text-xs place-items-center gap-5 p-4 grid-cols-1 md:grid-cols-3'>
                    {/* Header {1} */}
                    <p className='text-leadistroWhite/90 font-extrabold'>Platform</p>
                    {/* Header {2} */}
                    <p className='text-leadistroWhite/90 font-extrabold'>Company</p>
                    {/* Header {3} */}
                    <p className='text-leadistroWhite/90 font-extrabold'>Get The App</p>

                    <p>Dashboard</p>

                    <p>Blog</p>

                    <Button size={'sm'} variant={'outline'} className='flex rounded-full hover:bg-leadistroBlack hover:text-leadistroRed hover:border-leadistroRed items-center justify-center space-x-2'>
