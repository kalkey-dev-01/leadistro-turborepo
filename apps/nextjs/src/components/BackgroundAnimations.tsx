...
const BackgroundAnimation: React.FC = () => {
    return (
        <div className='absolute top-3 left-0 right-0'>
            <div className="animate-blob animation-delay-2000 filter blur-xl  bg-gradient-to-tr from-leadistroRed via-leadistroWhite to-red-900 absolute top-0 hidden md:inline-flex md:-left-96   bg-leadistroRed  w-80  h-80 rounded-full"></div>
            <div className="animate-blob animation-delay-2000 filter blur-xl  bg-gradient-to-tr from-leadistroRed via-leadistroWhite to-red-900 absolute top-0 -left-4 md:-left-40   bg-leadistroRed  w-80  h-80 rounded-full"></div>
