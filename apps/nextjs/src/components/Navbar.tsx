...
import { poppins } from '~/templates/Main';
                    ...
                    <li className='inline-flex md:hidden'>
                        <Sheet>
                            ...
                            <SheetContent className='flex flex-col font-poppins items-center justify-start bg-gradient-to-b bg-leadistroBlack' side={'right'}>
                                ...
                                <SheetFooter>
                                    <SheetClose asChild>
                                        <Button variant={'outline'} className={`text-leadistroBlack border-2 rounded-2xl border-leadistroWhite/70 bg-leadistroRed font-black text-xl px-8 py-6 mt-8 ${poppins.className}`}>Register</Button>
                                    </SheetClose>
                                </SheetFooter>
                            </SheetContent>
                        </Sheet>
