    ...
    return (
        <Main meta={<Meta description='Download the App' title='Download Leadistro App' />}>
            <div className='flex flex-col items-center bg-leadistroBlack space-y-5 justify-center min-w-full min-h-screen'>
                <Heading1 className='text-leadistroWhite text-center font-poppins' textChildren='The Application is Still Under Development' />
                <Heading3 className='text-leadistroWhite text-center font-poppins' textChildren='Thank You For Your Interest In Leadistro' />
